...
The 0/1 learning curve shows underfitting at sample size 127 (.01 of training data) but performs relatively consistent at above 90% accuracy for both testing and training for at all sample sizes.  
